 ...
 <div id="sidebar">
	...
	<div class="MyprofileDetail">				
		...
		<li><span class="opener">나의 활동</span>
			<ul>
				...
				<li><a href="mypagemylike.do">나의 좋아요</a></li>
	...
	<li><span class="opener">나의 쪽지함<font class="unreadMsg" color="white"></font></span>
		...
		<li><span class="opener">나의 좋아요</span>
			<ul>
			    <li><a href="mypagemyplaylistlike.do">나의 소모임</a></li>
			    <li><a href="mypagemyboardlistlike.do">나의 게시글</a></li>
				<li><a href="mypagemyfundinglike.do">나의 후원</a></li>
