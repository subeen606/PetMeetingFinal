...
/* 반려동물 행사 안내 게시판 */
DROP TABLE PM_EVENTBOARD
CASCADE CONSTRAINTS;

DROP SEQUENCE PM_EVENTBOARD_SEQ;

CREATE TABLE PM_EVENTBOARD(
	SEQ NUMBER PRIMARY KEY,
	TITLE VARCHAR2(200),
	CONTENT CLOB,
	FILENAME VARCHAR2(300),
...
CREATE SEQUENCE PM_EVENTBOARD_SEQ
START WITH 1
INCREMENT BY 1;

SELECT * FROM PM_EVENTBOARD;
...
SELECT R.SEQ, R.BAD_EMAIL, R.EMAIL, R.REASON, M.NICKNAME
		FROM PM_MEMBER_REPORT R JOIN PM_MEMBER M ON R.EMAIL = M.EMAIL
		WHERE R.BAD_EMAIL='abc@abc.com'
		ORDER BY R.SEQ ASC
