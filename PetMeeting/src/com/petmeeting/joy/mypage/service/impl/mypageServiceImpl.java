...
public class mypageServiceImpl implements mypageService {
	...
	public List<MypageFollowDto> myFollolistemail(MemberDto member) {
		...
		//리턴해 줄 리스트에 담길 dto
		MypageFollowDto rdto =  new MypageFollowDto(emaildto.getEmail(),
				                nickname ,
				                follower, 
				                following, 
				                intro, 
	...
	if(profile==null) {
	    ...
	    Mypagememandpet profile2=new Mypagememandpet(email,follower.getFollower(),follow.getFolloing(),nickname.getNickname());
