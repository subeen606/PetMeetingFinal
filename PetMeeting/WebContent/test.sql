/*-----  test ----- */
SELECT * FROM PM_MEMBER WHERE NICKNAME='진도라';
SELECT * FROM PM_MEMBER WHERE EMAIL='jinyj714@gmail.com';
...
VALUES('tata@naver.com', 'tata', '타타', '타타', '03932', '서울 마포구 월드컵로 240', null, '(성산동)', 01012341234, 0, 0, 0, 0, 3);

INSERT INTO PM_MYPROFILE(EMAIL, MYPROFILE_IMG, MYAGE, MYSEX, MYINTRO) 
VALUES((SELECT EMAIL FROM PM_MEMBER WHERE EMAIL='tata@naver.com'), NULL, NULL, NULL, '등록된 소개가 없습니다')
