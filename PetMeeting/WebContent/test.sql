/*-----  test ----- */
SELECT * FROM PM_MEMBER WHERE EMAIL='kyorororo3@gmail.com';
 
SELECT * FROM PM_MYPROFILE WHERE EMAIL='321';
...
DELETE FROM PM_CHECK_MYPROFILE WHERE EMAIL='www';
DELETE FROM PM_CHECK_LOGIN WHERE EMAIL='zzz';
DELETE FROM PM_CHECK_PETPROFILE WHERE EMAIL='www';
DELETE FROM PM_PETPROFILE WHERE EMAIL='www';
DELETE FROM PM_MYPROFILE WHERE EMAIL='www';
