...
<!-- Bootstrap CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/store_resources/css/bootstrap.min.css">
<!-- animate CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/store_resources/css/animate.css">
<!-- owl carousel CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/store_resources/css/owl.carousel.min.css">
<!-- themify CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/store_resources/css/themify-icons.css">
<!-- flaticon CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/store_resources/css/flaticon.css">
<!-- font awesome CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/store_resources/css/magnific-popup.css">
<!-- style CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/store_resources/css/style.css">
<!-- 우리가 추가한 css -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/store_resources/css/custom.css">
...
<body>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="s-navi-bottom">
							<div class="s-logo">
								<img alt="이미지없음"
									src="${pageContext.request.contextPath}/common/navbar/img/petmeetinglogo.png"
	...
	<div class="container s-container">
		...
		<div class="mystore-container">
						...
						<table class="searchBox">
							...
							<tbody>
								<tr>
									...
									<td>
										<ul class="searchDate">
											<li><span class="checkbox2"> <input type="radio"
													name="dateType" id="dateType1"
													onclick="setSearchDate('0d')"> <label
													for="dateType1">오늘</label>
											</span></li>
											<li><span class="checkbox2"> <input type="radio"
													name="dateType" id="dateType2"
													onclick="setSearchDate('1w')"> <label
													for="dateType2">1주일</label>
											</span></li>
											<li><span class="checkbox2"> <input type="radio"
													name="dateType" id="dateType3"
													onclick="setSearchDate('1m')"> <label
													for="dateType3">1개월</label>
											</span></li>
											<li><span class="checkbox2"> <input type="radio"
													name="dateType" id="dateType4"
													onclick="setSearchDate('3m')"> <label
													for="dateType4">3개월</label>
											</span></li>
											<li><span class="checkbox2"> <input type="radio"
													name="dateType" id="dateType5"
													onclick="setSearchDate('6m')"> <label
													for="dateType5">6개월</label>
											</span></li>
										</ul>
										<div class="clearfix">
											<!-- 시작일 -->
											<span class="dset"> <label><input type="text"
													class="datepicker inpType" name="startdate"
													id="searchStartDate" value=""> <img alt=""
													src="${pageContext.request.contextPath}/store_resources/images/calendar.png">
											</label>
											</span> <span class="demi"><b>~</b></span>
											<!-- 종료일 -->
											<span class="dset"> <label><input type="text"
													class="datepicker inpType" name="enddate"
													id="searchEndDate" value=""> <img alt=""
													src="${pageContext.request.contextPath}/store_resources/images/calendar.png">
											</label>
											</span>
										</div>
			...
			<div class="info-wrap" style="padding: 20px 10px; background: #e0f0ee; border-radius: 5px">
				<p>※ 나의 취소내역에서의 조회는 주문 날짜에 의한 주문조회입니다. (취소 날짜X)</p>
			</div>
			...
			<table class="order_list">
				...
				<tbody>
					<c:if test="${olist == null || olist.size() == 0 }">
						<tr>
							<td colspan="5" style="height: 250px; background-color: #fafafa;">취소한내역이 없습니다</td>
						</tr>
					</c:if>
					<c:if test="${olist != null }">
						<c:forEach items="${olist }" var="list">
							<c:if test="${list.status eq 3 }">
								<tr>
									<td><a
										href="orderdetail.do?ordernumber=${list.ordernumber }">${list.ordernumber }</a>
									</td>
									...
									<td><fmt:formatNumber value="${list.totalprice +2500 }"
											pattern="#,###" /></td>
									<td>주문취소</td>
								</tr>
							</c:if>
					...
					<tr>
						<td colspan="5"><jsp:include
							page="/WEB-INF/views/store/mystore/paging.jsp" flush="false">
	...
	<!-- popper js -->
	<script
		src="${pageContext.request.contextPath}/common/navbar/js/popper.min.js"></script>
	<!-- bootstrap js -->
	<script
		src="${pageContext.request.contextPath}/common/navbar/js/bootstrap.min.js"></script>
	<!-- counterup js -->
	<script
		src="${pageContext.request.contextPath}/common/navbar/js/jquery.counterup.min.js"></script>
	<!-- waypoints js -->
	<script
		src="${pageContext.request.contextPath}/common/navbar/js/waypoints.min.js"></script>
	<!-- easing js -->
	<script
		src="${pageContext.request.contextPath}/common/navbar/js/jquery.magnific-popup.js"></script>
	<!-- particles js -->
	<script
		src="${pageContext.request.contextPath}/common/navbar/js/owl.carousel.min.js"></script>
	<!-- custom js -->
	<script
		src="${pageContext.request.contextPath}/common/navbar/js/custom.js"></script>
...
$("#searchEndDate").on("change", function () {
	$("#_orderReference").attr("action", "mycancel.do").submit();
});
