...
<input type="hidden" name="email" value="${login.email }">
    <div class="container">
    	<div class="playWrtieContainer">
    		<div class="Title">
    		<img src="${pageContext.request.contextPath}/playboard_resources/img/playboardIcon.png" width="100px">&nbsp;&nbsp;소모임 만들기
    		</div>
    		<div class="writeRow">
    		...
    		<div class="writeRow">
	    		...
	    		<div class="writeInput">
	    			<label>
	    			<input type="text" autocomplete="off" id="_playDate" readonly="readonly" placeholder="모임 예정일" >
    		...
    		<div class="writeRow">
	    		...
	    		<div class="writeInput">
	    			<label>
	    			<input type="text" autocomplete="off" id="_endDate" readonly="readonly" placeholder="모집 마감일" >	   
    		...
    		<div class="writeRow">
	    		...
	    		<div class="writeInput-address">
					...
					<input type="text" name="location" id="sample6_address" placeholder="주소"><button type="button" id="findAddr" onclick="sample6_execDaumPostcode()">우편번호 찾기</button><br>
    		...
    		<div class="writeRow">
	    		...
	    		<div class="writeInput">
	    			<input type="text" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" name="price" id="_price" style="width: 100px;">원
	    		</div>
    		</div>
    		...
    		<div class="writeRow">
	    		...
	    		<div class="writeInput">
	    			<input type="text" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" name="people" id="_people" style="width: 100px;">명
	    		</div>
    		</div>
    		...
    		<div class="writeRow">
	    		...
	    		<div class="writeInput">
	    			...
	    			<input type="hidden" name="hash4">
	    			<input type="hidden" name="hash5">	    			
	    		</div>
    		</div>
    		
    		<div class="writeRow" style="border: none;">
	    		<button type="button" id="submitBtn" style="margin-left: auto; margin-right: auto;">모임 등록</button>
    		</div>
