...
<div class="content">
	<div class="container">
		...
		<jsp:useBean id="pUtil" class="com.petmeeting.joy.playboard.Util.PlayboardUtil"/>
			<tr>
				<th>행사 제목</th>
				<td><input type="text" name="title" style="width: 80%;" value="${detail.title }"></td>
			</tr>
			...
			<tr>
				...
				<td>
					<label>
					<jsp:setProperty property="myDate" name="pUtil" value="${detail.event_sdate }"/>
	    			<input type="text" autocomplete="off" id="_startDate" readonly="readonly" placeholder="행사 시작일" value='<jsp:getProperty property="formatDate" name="pUtil"/>'>
	    			...
	    			&emsp;~&emsp; 	
	    			<label>
	    			<jsp:setProperty property="myDate" name="pUtil" value="${detail.event_edate }"/>
	    			<input type="text" autocomplete="off" id="_endDate" readonly="readonly" placeholder="행사 종료일" value="<jsp:getProperty property="formatDate" name="pUtil"/>">	   
			...
			<tr>
				<th>행사 장소</th>
				<td>
					<input type="text" name="location" id="sample6_address" placeholder="주소" value="${detail.location }" style="width: 60%;"> <button type="button" id="findAddr" onclick="sample6_execDaumPostcode()">우편번호 찾기</button><br>
		...
		<button type="button" id="submitBtn" style="margin-left: auto; margin-right: auto;">수정하기</button>
...
$(function () {
	...
	$("#submitBtn").click(function () {
		...
		$("#updateFrm").attr("action", "adminEventUpdateAf.do").submit();
	});
});
