	...
	<span><strong>${dto.category}</strong></span>
		...
		<span style="font-size: 20px">
			<c:if test="${dto.myprofile_img eq null}">
				<img src="${pageContext.request.contextPath}/playboard_resources/img/user.png" class="freeprofile">
			</c:if>
			 
			<c:if test="${not empty dto.myprofile_img}">
				<img src="${pageContext.request.contextPath}/upload/${dto.myprofile_img}" class="freeprofile">
			</c:if>
            		 ...
            		 <table class="table" style="word-wrap:break-word;word-break:break-all;">
                        ...
                        <tbody>
                         ...
                         <tr>
                           ...
                           if(cm.getDepth() !=0){
							%>
							<td rowspan = "2" style="padding-top: 12px; padding-left: 0px; padding-right: 0px; padding-bottom: 0px; background-color:#f5f5f5">
							<img src='freeboard_resources/images/reply.png'  width="20px" height="20px" 
							style="padding-top: 0px; padding-left: 0px; padding-right: 0px; padding-bottom: 0px; margin-left:20px;"/>
							</td>
							<td rowspan = "2" style="padding-top: 12px; padding-left: 0px; padding-right: 0px; padding-bottom: 0px; background-color:#f5f5f5"	>
								<%if(cm.getMyprofile_img() == null) {%>
                                <img src="${pageContext.request.contextPath}/playboard_resources/img/user.png" width="50px" class="profilephoto" height="50px">
                                <%}else{ %>
                                <img src="${pageContext.request.contextPath}/upload/<%=cm.getMyprofile_img() %>" class="profilephoto" width="50px" height="50px">
                                <%} %>
                             </td>
                             
                             <td style="word-break: break-all; background-color:#f5f5f5">
                        <img src="freeboard_resources/gradeimg/<%=cm.getFilename()%>" class="grade-icon"><%=cm.getNickname()%>
                        </td>
                        
                        <td style="word-break: break-all; background-color:#f5f5f5"><%=transFormat.format(to)%></td>
                        <td style="word-break: break-all; background-color:#f5f5f5">
                        ...
                        if(user == null || user.getEmail() == null){
                           ...
                           if(cm.getEmail() != null  && user.getEmail() != null){
                              String commentId = cm.getEmail();
                              String userId = user.getEmail();
                              
                              if(cm.getEmail().equals(user.getEmail())){
                           %>
                        ...
                        <td style="word-break: break-all; background-color:#f5f5f5">
                           <div id="replycomment-click<%=cm.getSeq()%>">
                              <img src="freeboard_resources/images/reply.png" width="20px" height="20px" onclick="recommentOpenReply(this,<%=cm.getSeq()%>)" style="cursor: pointer;">
                           </div>
                        </td>
                        <td style="word-break: break-all; background-color:#f5f5f5">
                     <%--       <img src="freeboard_resources/images/report.png" width="20px" height="20px" onclick="cmreportBtn(<%=cm.getSeq()%>,<%=cm.getEmail()%>)" style="cursor: pointer;"> --%>
                           <img src="freeboard_resources/images/report.png" width="20px" height="20px" onclick="cmreportBtn(<%=cm.getSeq()%>)" style="cursor: pointer;">
                        
                        </td>
                     </tr>
                     <tr style="background-color:#f5f5f5">
                        <td colspan="8" style="text-align: left; word-break: break-all; font-size: 20px" id="reply<%=cm.getSeq()%>"><%=cm.getContent()%>
                     </tr>
							...
							<%}else{%>
								...
								<%if(cm.getMyprofile_img() == null) {%>
                                <img src="${pageContext.request.contextPath}/playboard_resources/img/user.png" width="50px" class="profilephoto" height="50px" style="margin: 0 auto; margin-left: 15px; float:center; align:center;">
                                <%}else{ %>
                                <img src="${pageContext.request.contextPath}/upload/<%=cm.getMyprofile_img() %>" class="profilephoto" width="50px" height="50px" style="margin: 0 auto; margin-left: 15px; float:center; align:center;">
                                <%} %>
                             	</td>
