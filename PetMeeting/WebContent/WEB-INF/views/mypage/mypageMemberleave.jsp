...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/mypage_resources/mypage_h/mypagememberleave/css/mypagememberleave.css?after">
...
제24조(재판권 및 준거법)
 ...
 ②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
            ...
            <tr>
              <td>
                <input type="checkbox" id="check1">이용약관에 동의합니다.<br><br>
...
'정보통신망 이용촉진 및 정보보호 등에 관한 법률'의 거래기록 보존 의무에 따른 보존: 1년
            ...
            <tr>
              <td>
                <input type="checkbox" id="check2">개인정보 수집 및 이용에 대한 안내에 동의합니다.
              </td>
            </tr>
          </table>
    ...
    <tr>
    <td align="center">
    <a href="#"> <button type = "button"  class="btn_order" id="leave" style="margin:10px;">회 원 탈 퇴</button></a>
  <a href="#"> <button type = "button"  class="btn_cancel" style="margin:10px;">취 소 하 기</button></a>
    </td>
    </tr>
</table>
<br><br>
...
<fieldset class="step3">
 ...
 <div class="fs-title" align="center">회원님, 불편하신 점이 있으셨나요? 회원탈퇴 하기시 전에 아래의 사항들을 먼저 확인 해 주세요</div>


<div class="fs-title2">
<h3 class="fs-subtitle"><img alt=""src="${pageContext.request.contextPath}/mypage_resources/mypage_h/mypagememberleave/images/check.png"> 회원님의 포인트가 모두 사라집니다.</h3>
<h3 class="fs-subtitle2">-회원님의 포인트와 적립금 등이 모두 사라집니다.</h3>
<h3 class="fs-subtitle"><img alt=""src="${pageContext.request.contextPath}/mypage_resources/mypage_h/mypagememberleave/images/check.png"> 회원님의 모든 기록이 사라집니다.</h3>
<h3 class="fs-subtitle2">-나의 쪽지함,나의 구독,나의 쇼핑리스트,나의 참여 모임등의 모든 기능은 회원가입을 하신 회원님에게만 제공되는 기능 입니다.</h3>
<h3 class="fs-subtitle"><img alt=""src="${pageContext.request.contextPath}/mypage_resources/mypage_h/mypagememberleave/images/check.png"> 탈퇴 후 해당 아이디로 더이상 회원가입이 불가능 합니다 <a href="#">계정 비활성화</a></h3>
<h3 class="fs-subtitle2" id="fs-subtitle2">-잠시 계정을 비활성화 하고 싶은 것 이라면 계정 비활성화를 선택 하여 주세요.</h3>


 <div class="fs-title" align="center"></div>

<h3 class="fs-subtitle4">회원님의 탈퇴 사유를 알려주세요.</h3>
<div class="container">
<ul>
  <li>
    <input type="radio" id="f-option" name="selector" value="정보부족">
    <label for="f-option">필요하고 유용한 정보가 없어서</label>
    
    <div class="check"></div>
  </li>
  
  <li>
    <input type="radio" id="s-option" name="selector" value="이메일변경">
    <label for="s-option">EMAIL변경을 위하여</label>
 ...
 <li>
    <input type="radio" id="e-option" name="selector" value="기타">
    <label for="t-option">기타</label>

</li>
</ul>
</div>

  <a href="#"> <button type = "button"  class="btn_order" id="leaveok" style="margin:10px;">회 원 탈 퇴</button></a>
</div>
	...
	$("#leaveok").click(function () {
		...
		if($('input:radio[name=selector]').is(':checked')== false){
	      alert("회원님의 회원탈퇴 이유를 선택 해 주세요");
	      ...
	      return false;
     		...
     		//	alert($("input[name='selector']:checked").val());

         		
         		
    			$.ajax({
    				type:"POST",
    				 url:"mypagememberleaveaf.do",
    				 async: false,	
    				 data:{"reason":$("input[name='selector']:checked").val()},
    				 success:function(data){
    					 alert("성공 적으로 회원탈퇴가 되었습니다 이용 해 주셔서 감사합니다");
