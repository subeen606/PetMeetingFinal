...
<link rel="stylesheet" href="${pageContext.request.contextPath}/mypage_resources/mypage_j/css/mypetprofile.css">
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							...
							<div class="petprofile-container">
								<div class="pageHead">
									<h1>나의 펫프로필</h1>
									<hr>
								</div>
								...
								<form name="petProfileForm" id="_petProfileForm">	
									...
									<div class="mypageHomebox_1">
										<div class="input_row">
											<p class="input_title">펫프로필 이미지</p>								
									...
									<div class="mypageHomebox_1">
										<div class="input_row">
											<p class="input_title">펫나이</p>
											<span>
											<input name="petage" type="text" size="50px">
											</span>
									...
									<div class="mypageHomebox_1">
										<div class="input_row">
											<p class="input_title">펫소개</p>
											<textarea name="petintro">나의 펫에 대한 소개를 작성해주세요</textarea>
										</div>											
									</div>					
								</form>
								...
								<div class="mypageHomebox_1">
									<div class="input_row">
										<button class="profile_Btn" id="petProfile_insertBtn">프로필 등록하기</button>
